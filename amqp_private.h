 ...
 */
#define RABBITMQ_C_ERROR_CATEGORY_MASK (1 << 29)

#define RABBITMQ_C_ERROR_CATEGORY_CLIENT (0 << 29) /* librabbitmq error codes */
#define RABBITMQ_C_ERROR_CATEGORY_OS (1 << 29) /* OS-specific error codes */

/* librabbitmq error codes */
#define RABBITMQ_C_NO_ERROR 0
#define RABBITMQ_C_ERROR_NO_MEMORY 1
#define RABBITMQ_C_ERROR_BAD_AMQP_DATA 2
#define RABBITMQ_C_ERROR_UNKNOWN_CLASS 3
#define RABBITMQ_C_ERROR_UNKNOWN_METHOD 4
#define RABBITMQ_C_ERROR_HOST_NOT_FOUND 5
#define RABBITMQ_C_ERROR_INCOMPATIBLE_AMQP_VERSION 6
#define RABBITMQ_C_ERROR_CONNECTION_CLOSED 7
#define RABBITMQ_C_ERROR_MAX 7
